...
void SquircleRenderer::prepareShader(Stage stage)
{
    ...
    if (stage == VertexStage) {
        filename = QStringLiteral("/home/david/Programmieren/C++/QT/kSTL/src/shaders/squircle.vert.spv");
    } else {
        Q_ASSERT(stage == FragmentStage);
        filename = QStringLiteral("/home/david/Programmieren/C++/QT/kSTL/src/shaders/squircle.frag.spv");
    }
